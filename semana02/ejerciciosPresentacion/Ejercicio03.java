...
public class Ejercicio03 {
    ...
    // Se define el modelo Usuario como un Java Record (disponible en Java 14+ / Java 16 SE)
    // Permite una definición inmutable, concisa y genera automáticamente getters, equals, hashCode y toString.
    ...
    public static void main(String[] args) {
        ...
        // Explicación:
        // 1. .filter(Usuario::active): Filtra mediante el getter del record/clase para validar si está activo.
        ...
        // 2. .map(u -> u.name().toUpperCase()): Combina la extracción del nombre y la conversión a mayúsculas
