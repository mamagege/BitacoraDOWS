...
/**
 * EJERCICIO #4:
 * Dado un listado de Usuarios y utilizando los mismos atributos anteriores (id, name, age, active),
...
public class Ejercicio04 {
    ...
    public static void main(String[] args) {
        ...
        // 1. .stream(): Inicia el flujo de procesamiento sobre la lista de objetos Usuario.
        // 2. .filter(u -> u.age() >= 18): Filtra las personas evaluando que su edad sea mayor o igual a 18 años.
        // 3. .map(Usuario::name): Proyecta/extrae únicamente el atributo de nombre de los objetos filtrados.
        // 4. .toList(): Colecta los nombres resultantes en una colección inmutable de tipo List<String>.
