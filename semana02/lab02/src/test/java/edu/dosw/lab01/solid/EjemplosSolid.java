 ...
 * Cada escenario muestra el Anti-patrón (MAL) vs. la Solución Refactorizada
 * (BIEN).
 */
public class EjemplosSolid {
    ...
    public static class OCP_AntiPattern {
        // ❌ MAL: Cada vez que el negocio acepta un nuevo método de pago (ej. Crypto,
        // ApplePay),
        // debemos abrir y modificar esta clase central con más 'if' o 'switch',
        // arriesgando romper los existentes.
    ...
    public static class OCP_Solution {
        // ✔️ BIEN: Abierto a la extensión (nuevas pasarelas), cerrado a la
        // modificación.
        ...
        public static class CreditCardGateway implements PaymentGateway {
            ...
            public PaymentResult charge(BigDecimal amount) {
                return new PaymentResult(true, "CC-" + UUID.randomUUID(),
                        "Credit Card charged successfully: $" + amount);
            }
        }
        ...
        public static class CryptoGateway implements PaymentGateway {
            ...
            @Override
            public PaymentResult charge(BigDecimal amount) {
                return new PaymentResult(true, "0x" + UUID.randomUUID().toString().replace("-", ""),
                        "Crypto verified on chain: $" + amount);
            }
        }
    ...
    public static class LSP_AntiPattern {
        // ❌ MAL: FixedTermDepositAccount (Plazo Fijo) hereda de BankAccount pero no
        // permite retiros,
        // lanzando una excepción inesperada que rompe la expectativa del cliente
        // polimórfico.
    ...
    public static class LSP_Solution {
        // ✔️ BIEN: Segregamos los contratos para que los subtipos respeten fielmente
        // todas sus garantías.
    ...
    public static class ISP_AntiPattern {
        // ❌ MAL: Interfaz monolítica ("gorda"). Obliga a dispositivos simples como una
        // bombilla
        // a implementar métodos de seguridad, cámaras o termostatos que no le
        // corresponden.
    ...
    public static class DIP_AntiPattern {
        // ❌ MAL: Las clases de alto nivel dependen de detalles de bajo nivel
        // instanciados con 'new'.
        // Imposible hacer pruebas unitarias sin una base de datos MySQL real y un
    ...
    public static class DIP_Solution {
        // ✔️ BIEN: El módulo de alto nivel define sus puertos (interfaces), y la
        // infraestructura
