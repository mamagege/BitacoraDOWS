 ...
 * 
 * Datos de Entrada:
 * List<String> words = List.of("java", "stream", "api", "functional", "code",
 * "git");
 */
public class Ejercicio02 {
    ...
    public static void main(String[] args) {
        ...
        // Explicación:
        // 1. .filter(w -> w.length() > 4): Retiene solo palabras con longitud > 4
        // ("stream", "functional").
        // 2. .map(String::toUpperCase): Transforma cada cadena a mayúsculas mediante
        ...
        // 3. .peek(System.out::println): Operación intermedia que permite
        // inspeccionar/imprimir los elementos
        // que pasan por esa etapa sin alterar el flujo (ideal para
        // depuración/debugging).
        // 4. .count(): Operación terminal que cuenta la cantidad final de elementos en
        // el flujo.
