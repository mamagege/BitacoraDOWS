...
/**
 * EJERCICIO #1:
 * Dada una lista de números enteros, necesitamos obtener una nueva lista solo
 * con los números pares mayores a diez.
 * 
 * Datos de Entrada:
...
public class Ejercicio01 {
    ...
    public static void main(String[] args) {
        ...
        // 3. .filter(n -> n > 10): Evalúa que sea estrictamente mayor a 10 de forma
        // aislada.
        // 4. .toList(): Colecciona el resultado en una nueva lista inmutable (Java
        // 16+).
        ...
        // Explicación:
        // 1. .filter(n -> n % 2 == 0 && n > 10): Utiliza el operador lógico AND (&&)
        // para evaluar
        // ambas condiciones en un solo paso lambda, reduciendo la cantidad de etapas en
        // el pipeline.
